...
const Heading = ({ headingLineOne, headingLineTwo, headingDescription, mouseText, scrollToLocation }: headingProps) => {
    return (
        <div className="md:pt-[4.94rem] mt-[10rem]" id="heading">
            ...
            <div className="flex flex-col items-center justify-center gap-[1.5rem]">
                ...
                <div className="flex md:w-[55.8125rem] justify-center ">
                    <p className="md:text-[1.5rem] text-[1.5rem] font-[100] leading-[2.25rem] text-center">{headingDescription}</p>
                </div>
            </div>
            <div className="flex justify-center items-center md:mt-[5.69rem] mt-[3rem] mb-[2.87rem]">
                <a href={scrollToLocation} className="md:w-[10.575rem] w-[5rem] md:h-[10.575rem] h-[6.5rem] border-[1px] border-[#DAC5A7] rounded-full py-[1rem] flex  flex-col items-center justify-center md:gap-[1rem] group hover:rotate-180 duration-300 delay-200">
                    <p className="md:text-[1.25rem] text-[0.8rem] text-center font-[700] leading-[1.5rem] group-hover:scale-x-[-1] group-hover:-scale-y-[1] transform duration-300" >{mouseText}</p>
