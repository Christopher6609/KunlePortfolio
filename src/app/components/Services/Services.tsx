...
const Services = () => {
    return (
        <div className="py-[6.56rem] space-y-[3.31rem]">
            ...
            <div className="flex justify-center items-center">
                <a href="mailto:odeniyichristopher7@gmail.com" className="w-[7.5625rem] h-[3.0625rem] px-[0.75rem] py-[0.5rem] flex justify-center items-center rounded bg-[#EDD6B6] text-[#000] text-[1.21875rem] leading-[1.5rem] font-[500] tracking-[0.01831rem]">Hire Me </a>
            </div>
        </div>
    )
}
