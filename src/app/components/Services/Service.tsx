...
const Service = ({ service }:serviceProps) => {
    ...
    return (
        <div className="md:w-[25rem] md:h-[20.0625rem] dark:bg-[#0E0E0E] bg-[#DAC5A7] rounded border-[#dac5a71a] border flex items-center px-[1.5rem] hover:dark:bg-[#DAC5A7] hover:text-[#000]">
