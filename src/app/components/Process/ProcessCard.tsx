...
const ProcessCard = ({id,heading,description}:processCardProps) => {
    return (
        <div className="w-[30.9375rem] h-[20.0625rem] p-[1.5rem] bg-[#0E0E0E] rounded border border-[#dac5a71a] flex flex-col justify-center space-y-[0.5rem] relative hover:bg-[#DAC5A7] hover:text-[#000]" >
