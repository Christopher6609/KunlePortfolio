...
const ProcessCard = ({id,heading,description}:processCardProps) => {
    return (
        <div className="md:w-[30.9375rem] w-[20rem] h-[20.0625rem] p-[1.5rem] dark:bg-[#0E0E0E] bg-[#DAC5A7] rounded border border-[#dac5a71a] flex flex-col justify-center space-y-[0.5rem] relative dark:hover:bg-[#DAC5A7] hover:text-[#000]" >
